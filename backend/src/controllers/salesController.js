...
export const deleteAllSales = [
  asyncHandler(async (req, res) => {
    ...
    broadcastRealtime("sales:changed", { action: "deleted-all", result });
    broadcastRealtime("inventory:changed", { action: "stock-updated", resource: "sales", result });
    broadcastRealtime("credits:changed", { action: "deleted-all", result });
