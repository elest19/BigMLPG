        ...
        <dl className="space-y-2 text-sm ">
          {details.map((item) => (
            <div key={item.label} className="flex flex-col gap-1 rounded-lg bg-white border border-slate-200 shadow-md p-3 sm:flex-row sm:items-start sm:justify-between">
              <dt className="text-xs font-bold uppercase tracking-wide text-slate-600">{item.label}</dt>
              <dd className="text-sm font-semibold text-slate-500 rounded-lg px-2 py-1 sm:text-right">
